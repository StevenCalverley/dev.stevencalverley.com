...
@section('content')
  ...
  <section class="outer-container space-bottom">
   ...
   <section class="inner-container space-bottom">
    ...
    <p>I very passionate about <strong>software architecture</strong> and <strong>user experience</strong>.</p>
  </section>
